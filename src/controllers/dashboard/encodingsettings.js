...
function loadPage(page, config, systemInfo) {
    ...
    page.querySelector('#chkPreferSmallerSourceFiles').checked = config.PreferSmallerSourceFiles || false;
...
function onSubmit() {
    ...
    const onDecoderConfirmed = function () {
        ...
        ApiClient.getNamedConfiguration('encoding').then(function (config) {
            ...
            config.PreferSmallerSourceFiles = form.querySelector('#chkPreferSmallerSourceFiles').checked;
